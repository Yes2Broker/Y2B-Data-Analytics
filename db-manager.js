  ...
  sec.innerHTML = `
    ...
    <div id="dbPanel" style="display:none">
      ...
      <div class="db-backup-tip">
        ...
        Tip: before clearing or replacing a table, export your current data from each section using its "Export to Excel" button.
      </div>
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.nav-item[data-section="admin"]').forEach(el => {
